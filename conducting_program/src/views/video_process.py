...
class VideoProcessView(tk.Frame):
    ...
    def __init__(
        ...
        title = tk.Label(header, text="Video", bg=widget_background, fg=widget_font_color, font=widget_title_font, anchor="e")
        ...
        panel_container.grid(row=1, column=0, sticky="ns", padx=(6, 12), pady=12)
        ...
        self.start_button_frame = self._create_styled_button(panel, "Start", lambda: None, row=9, sticky="sew", return_frame=True)
